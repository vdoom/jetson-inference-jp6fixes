...
<img src="https://github.com/vdoom/jetson-inference-jp6fixes/raw/master/docs/images/webrtc-dash.jpg" width="1000">
...
<img src="https://github.com/vdoom/jetson-inference-jp6fixes/raw/master/docs/images/webrtc-dash-model-load.jpg" width="400">
...
To load a customized classification or detection ONNX model that you trained with PyTorch from the Hello AI World tutorial (i.e. with [`train.py`](pytorch-cat-dog.md#re-training-resnet-18-model) or [`train_ssd.py`](https://github.com/vdoom/jetson-inference-jp6fixes/blob/dev/docs/pytorch-collect-detection.md#training-your-model)), switch to the `Import` tab:

<img src="https://github.com/vdoom/jetson-inference-jp6fixes/raw/master/docs/images/webrtc-dash-model-import.jpg" width="400">
...
<img src="https://github.com/vdoom/jetson-inference-jp6fixes/raw/master/docs/images/webrtc-dash-add-stream.jpg" width="400">
...
<img src="https://github.com/vdoom/jetson-inference-jp6fixes/raw/master/docs/images/webrtc-dash-event-table.jpg" width="750">

You can filter and sort by column in the table, and visualize the results in the Event Timeline:

<img src="https://github.com/vdoom/jetson-inference-jp6fixes/raw/master/docs/images/webrtc-dash-event-timeline.jpg" width="750">
...
<img src="https://github.com/vdoom/jetson-inference-jp6fixes/raw/master/docs/images/webrtc-dash-actions.jpg" width="400">
